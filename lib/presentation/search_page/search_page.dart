                    ...
                    child: Wrap(
                      ...
                      children: List<Widget>.generate(
                        ...
                        ChipviewmarvelItemModel model = controller
                            .searchModelObj.value.chipviewmarvelItemList[index];
                        return ChipviewmarvelItemWidget(model);
                      }),
                    ),
                  ),
                  Padding(
                      ...
                      child: Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller
                              .searchModelObj.value.listItemList.length,
                          itemBuilder: (context, index) {
                            ListItemModel model = controller
                                .searchModelObj.value.listItemList[index];
